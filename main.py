...
class Game:
    ...
    def update(self):
        ...
        if self.player1.vel.y > 0:
            ...
            if hits1:
                lowest1 = hits1[0]
                for hit1 in hits1:
                    if hit1.rect.bottom > lowest1.rect.bottom:
                        lowest1 = hit1
                    if self.player1.pos.y < lowest1.rect.bottom:
                        self.player1.pos.y = lowest1.rect.top + 1
        ...
        if self.player2.vel.y > 0:
            ...
            if hits2:
                lowest2 = hits2[0]
                for hit2 in hits2:
                    if hit2.rect.bottom > lowest2.rect.bottom:
                        lowest2 = hit2
    ...
    def events(self):
        ...
        for event in pg.event.get():
            ...
            if event.type == pg.KEYUP:
                ...
                if event.key == pg.K_s:
                    self.player1.uncrouch()
                if event.key == pg.K_k:
                    self.player2.uncrouch()
    ...
    def show_res_screen(self):
        # show the results of the current level
        pass
